...
const Layout = async ({ children }: LayoutProps) => {
    ...
    return (<div className = 'w-full flex h-screen'>
        <div className='flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6'>
            ...
            {friends.length > 0 ? (
                <div className='text-m font-bold leading-6 text-gray-800'>
                    Your Chats
                </div>
            ) : null}
                            ...
                            {sidebarOptions.map((option) => {
                                ...
                                return(
                                    <li key={option.id}>
                                        ...
                                        <span className='text-gray-400 border-gray-200 group-hover:border-orange-600 group-hover:text-orange-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625ram] font-medium bg-white'>
                    ...
                    <li className='-mx-6 mt-auto flex items-center'>
                        <div className='flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900'>
                            ...
                            <div className='flex flex-col'>
                                <span arai-hidden='true'>{session.user.name}</span>
