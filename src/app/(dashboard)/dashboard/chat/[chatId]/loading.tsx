                ...
                <div className='grid grid-cols-12 gap-y-2'>
                  <div className='col-start-6 col-end-13 p-3 rounded-lg'>
                    <div className='flex items-center justify-start flex-row-reverse'>
                      ...
                      <div className='relative mr-3 text-sm bg-orange-100 text-black py-2 px-4 border border-gray-100 rounded-xl dark:text-zinc-300'>
                  ...
                  <div className='col-start-1 col-end-8 p-3 rounded-lg'>
                    <div className='flex flex-row items-center'>
                      ...
                      <div className='relative ml-3 text-sm bg-white py-2 px-4 border border-gray-100 rounded-xl dark:text-zinc-300'>
                        <Skeleton className='ml-2' width={150} height={20} />
                      </div>
                    </div>
                  </div>
