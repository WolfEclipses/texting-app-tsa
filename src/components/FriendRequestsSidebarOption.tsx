...
const FriendRequestsSidebarOption: FC<FriendRequestsSidebarOptionProps> = ({
    ...
    return(
        <Link href='/dashboard/requests' className='text-gray-700 hover:text-orange-600 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold dark:text-zinc-300'>
